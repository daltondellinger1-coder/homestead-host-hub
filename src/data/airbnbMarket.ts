...
const RESEARCHED_HH_UNITS: Record<number, HomesteadUnit> = {
  1: {
    ...
    baths: 1,
    sleeps: 2,
    bestFor: 'Best proven 1BR long-stay listing for solo contractors, traveling nurses, and business travelers.',
    nightlyPrice: 95,
    monthlyPrice: 1735,
    ...
    reviews: 8,
    status: 'push',
    amenities: ['Airbnb listing verified', 'Guest Favorite', '5.0 rating', '8 reviews', 'Perfect long-stay ratings', 'Self check-in', 'Kitchen', 'WiFi', 'Free parking', 'TV', 'AC', 'Ceiling fan', 'Long-term stays'],
    amenityMap: {
      'Monthly friendly': true, 'Full kitchen': true, Laundry: true,
    ...
    missingOrUnclear: ['Dedicated workspace proof', 'Pet policy', 'Washer/dryer in-unit — listing only shows laundromat nearby', 'Whether August monthly quote includes every Airbnb fee/tax line'],
    photoActions: ['Keep business-traveler copy prominent', 'Add/feature laptop-ready work surface if present', 'Move self-check-in/entry and parking proof into first 5 photos', 'Call out nearby laundromat rather than implying in-unit laundry'],
    ownerAction: 'Unit 1 has the strongest 1BR long-stay proof. Consider a small base-rate raise after confirming the open August calendar still converts at the displayed monthly total.',
    ...
    dataStatus: 'Verified in Airbnb host/public listing: https://airbnb.com/h/homesteadhill1. Listed 1BR/1 bed/1 bath, 2 guests, $95/night, 10% weekly discount, 40% monthly discount, August 1–31 quote displayed $1,735 monthly after discount from $2,930, 5.0 from 8 reviews, Guest Favorite, Superhost, perfect long-stay ratings. July 1–31 returned unavailable.',
  },
  2: {
    unit: 'Unit 2',
    bedrooms: 1,
