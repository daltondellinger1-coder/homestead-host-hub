...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.booking_listing_mappings TO authenticated;
GRANT ALL ON public.booking_listing_mappings TO service_role;
...
GRANT SELECT ON public.booking_intake_events TO authenticated;
GRANT ALL ON public.booking_intake_events TO service_role;
