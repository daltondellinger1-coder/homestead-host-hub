...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.airbnb_market_listings TO authenticated;
GRANT ALL ON public.airbnb_market_listings TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.airbnb_price_snapshots TO authenticated;
GRANT ALL ON public.airbnb_price_snapshots TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.airbnb_availability_snapshots TO authenticated;
GRANT ALL ON public.airbnb_availability_snapshots TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.airbnb_weekly_briefings TO authenticated;
GRANT ALL ON public.airbnb_weekly_briefings TO service_role;
...
JOIN (VALUES
  ...
  ('homestead_hill','Unit 11',NULL::boolean,NULL::date),
  ('homestead_hill','Other HH units',NULL::boolean,NULL::date)
